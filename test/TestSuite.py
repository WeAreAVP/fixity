...
class TestSuite(unittest.TestCase):
    ...
    def testARunAlgorithmTestCases(self):
        ...
        self.assertEqual(response_test_confirm_file[0],
                         response_test_confirm_file[1], response_test_confirm_file[2])
        ...
        self.assertEqual(response_test_new_file[0],
                         response_test_new_file[1], response_test_new_file[2])
        ...
        self.assertEqual(response_test_change_file[0],
                         response_test_change_file[1], response_test_change_file[2])
        ...
        self.assertEqual(response_test_change_file_hp[0],
                         response_test_change_file_hp[1], response_test_change_file_hp[2])
        ...
        self.assertEqual(response_test_confirm_file_all[0],
                         response_test_confirm_file_all[1], response_test_confirm_file_all[2])
        ...
        self.assertEqual(response_test_confirm_file_ih[0],
                         response_test_confirm_file_ih[1], response_test_confirm_file_ih[2])
        ...
        self.assertEqual(response_test_moved_file[0],
                         response_test_moved_file[1], response_test_moved_file[2])
        ...
        self.assertEqual(response_test_confirm_file_delete[0],
                         response_test_confirm_file_delete[1], response_test_confirm_file_delete[2])
        ...
        self.assertEqual(response_test_moved_file_to_new_Directory[0],
                         response_test_moved_file_to_new_Directory[1], response_test_moved_file_to_new_Directory[2])
        ...
        self.assertEqual(response_test_moved_new_Directory_change_name[0],
                         response_test_moved_new_Directory_change_name[1], response_test_moved_new_Directory_change_name[2])
        #
        # Deleted   FileExists::NO     ||SameHashOfFile::YES    ||SameFilePath::YES    ||SameI-Node::YES
        ...
        self.assertEqual(response_test_moved_new_Directory_change_name_and_hash[0],
                         response_test_moved_new_Directory_change_name_and_hash[1], response_test_moved_new_Directory_change_name_and_hash[2])
        ...
        self.assertEqual(response_test_change_base_path[0],
                         response_test_change_base_path[1], response_test_change_base_path[2])
    ...
    def testBProjectTestCases(self):
        ...
        self.assertEqual(response_test_run_project[0],
                         response_test_run_project[1], response_test_run_project[2])

        # Project Run Unit test
        response_test_delete_project = self.project_test_case.delete_project(self.Fixtures.project_name)
        self.assertEqual(response_test_delete_project[0],
                         response_test_delete_project[1], response_test_delete_project[2])
        ...
        self.assertEqual(response_test_save_project[0],
                         response_test_save_project[1],
                         response_test_save_project[2])
        ...
        self.assertEqual(response_test_filters_files[0],
                         response_test_filters_files[1], response_test_filters_files[2])
    ...
    def testCEmailNotification(self):
        ...
        self.assertEqual(response_of_email[0],
                         response_of_email[1], response_of_email[2])
        ...
        self.assertEqual(response_of_email_attachment[0],
                         response_of_email_attachment[1], response_of_email_attachment[2])

        # Error Email Unit Test
        response_of_email_error = self.email_test_case.test_Error_email()
        self.assertEqual(response_of_email_error[0],
                         response_of_email_error[1], response_of_email_error[2])
        pass
    ...
    def testDRequiredFilesAndDirsCreation(self):
        ...
        self.assertEqual(response_of_is_config_file_exists[0],
                         response_of_is_config_file_exists[1], response_of_is_config_file_exists[2])

        # Is Database File Exists
        response_of_is_database_file_exists = self.requireds_creation_test_case.is_database_file_exists()
        self.assertEqual(response_of_is_database_file_exists[0],
                         response_of_is_database_file_exists[1], response_of_is_database_file_exists[2])

        # Is Debug File Exists
        response_of_is_debug_files_exists = self.requireds_creation_test_case.is_debug_files_exists()
        self.assertEqual(response_of_is_debug_files_exists[0],
                         response_of_is_debug_files_exists[1], response_of_is_debug_files_exists[2])

        # Is History Directory Exists
        response_of_is_history_dir_exists = self.requireds_creation_test_case.is_history_dir_exists()
        self.assertEqual(response_of_is_history_dir_exists[0],
                         response_of_is_history_dir_exists[1], response_of_is_history_dir_exists[2])

        # Is Reports Directory Exists
        response_of_is_report_dir_exists = self.requireds_creation_test_case.is_report_dir_exists()
        self.assertEqual(response_of_is_report_dir_exists[0],
                         response_of_is_report_dir_exists[1], response_of_is_report_dir_exists[2])
        ...
        self.assertEqual(response_of_is_schedules_dir_exists[0],
                         response_of_is_schedules_dir_exists[1], response_of_is_schedules_dir_exists[2])
