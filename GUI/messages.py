...
messages['filter_fail'] = 'There was a problem while setting the filter - please try again.'
messages['not_scanned_before'] = "This project has not been scanned yet.\nPlease run the project and then try again."
messages['already_using_algorithm'] = "This project is already using this algorithm.\nIf you wish to change the algorithm, please select a different one."
messages['algorithm_success'] = " checksum algorithm has been changed successfully."
messages['checksum_algorithm_change_failure'] = "Fixity discovered a change in the project directories when changing algorithms, and stopped the process.  Please see the scan report for further details.\nIf you wish to change the algorithm and commit the changed file, please change the algorithm a second time."
...
messages['configure_email_pref'] = 'No origin email account set.\nPlease configure an email account in the Preferences menu.'
...
messages['testing_email_error'] = "Fixity was unable to send email from the provided account.\n*Please ensure that you are connected to the Internet\n*Please ensure that your email credentials are correct"
messages['select_manifest_file'] = "Please select a valid project or manifest file path"
messages['invalid_file_given'] = "Invalid project/manifest file selected.\nPlease provide a valid project or manifest file to import."
messages['project_imported_sccuessfully'] = "The project was imported successfully!"
...
messages['project_not_ran_before'] = 'This project has not been scanned yet.\nPlease run the project and then try again.'
messages['alog_not_changed_mail'] = 'When attempting to change the project algorithm, Fixity found that files had been changed/moved/added/removed since the last scan.  Fixity will not change the algorithm unless all files are confirmed.\nThe report outlining the issues is attached.  If you wish to force Fixity to change the algorithm, you can do so by changing the algorithm again.'
messages['invalid_smtp_given'] = 'Invalid SMTP server given.\nPlease provide a valid SMTP server.'
messages['invalid_port_given'] = 'Invalid port given.\nPlease specify a valid port on the SMTP server.'
messages['invalid_import_file'] = "*Invalid project file provided.\nThe file provided was not a valid Fixity project file."
messages['duplicate_path'] = "The project contains duplicate directories to scan.\nPlease remove any duplicate paths and try again"
...
messages['path_not_found'] = "Invalid path provided.\nPlease provide a valid filepath."
messages['email_test_content'] = 'Testing email access for Fixity reporting...'
messages['close_unsaved'] = 'There are unsaved changes on this project, which will be discarded when closing Fixity.\nWould you like to stay on this project?'
messages['new_project_unsaved'] = 'There are unsaved changes on this project, which will be discarded when opening a different project.\nWould you like to stay on this project?'
